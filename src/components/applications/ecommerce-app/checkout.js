...
const Checkout = (props) => {
  ...
  useEffect(() => {
    const makeRequest = () => {
      try {
        axios
          .post(`${ServerUrl}/api/checkout/payment`, {
  ...
  console.log("stripeTokenstripeTokenstripeToken", stripeToken);
  return (
    <Fragment>
            ...
            <div className="row">
              <div className="col-lg-6 col-sm-12">
                ...
                >
                  ...
                  <StripeCheckout
                    ...
                    billingAddress
                    shippingAddress
                    description="Your Total bill is "
                    amoutn={"890"}
                    token={onToken}
                    stripeKey={KEY}
                  >
                    <button className="btn btn-primary mt-2 pull-right">
                      {PlaceOrder}
                    </button>
                  </StripeCheckout>
                </form>
              ...
              <div className="col-lg-6 col-sm-12">
                ...
                <div className="text-right m-t-20">
                  <button
                    className="btn btn-primary cart-btn-transform"
                    onClick={renderLink}
                  >
                    {ContinueShopping}
                  </button>
